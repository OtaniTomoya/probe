...
def test_basic_processing():
    ...
    try:
        ...
        sys.path.append('./src')
        from taxi_data_processor import TaxiDatasetCreator
        
        # 最初の3ファイルで処理テスト
        creator = TaxiDatasetCreator("./json", "./data/change_flag_filled0.csv")
...
def main():
    ...
    if all_passed:
        ...
        print("Run: python src/taxi_data_processor.py")
    else:
